    ...
    return (
        <section className={`tabs ${className}`}>
            ...
            <div className="tabs__wrapper">
                {tabOrder.map((tab, i) =>
                    <Tab key={tab + i}
                        className={`tabs__btn tab--active'}`}
            ...
            <div className="tabs__content" >
                {<Deposits className={`tabs__${TabTitles.DEPOSITS.toLowerCase()}`} />}
                {<Credits className={`tabs__${TabTitles.CREDITS.toLowerCase()}`} />}
                {<Insurance className={`tabs__${TabTitles.INSURANCE.toLowerCase()}`} />}
                {<Services className={`tabs__${TabTitles.ONLINE_SERVICES.toLowerCase().replace('_', '-')}`} />}
            </div>
            <Indicators className="tabs__indicators" count={tabOrder.length} />
        </section>
    );
};
